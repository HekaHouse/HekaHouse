...
public class AuthKey extends SugarRecord implements ThemisAPI {
    String tag="AuthenticationKey";
    public String iv;
    String encryptedKey;
    String nonce;
    String pwnonce;
    ...
    public AuthKey(LocalEncryptedContent lec) {
        this();
    ...
    public static List<AuthKey> findKeyForTag(String tag) {
        return AuthKey.find(AuthKey.class, "tag = ?",tag);
    }
    @Override
