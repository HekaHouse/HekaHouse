 ...
 */
public abstract class AgoniAdapter<T, VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> {
    private static final String TAG = "FirebaseRecyclerAdapter";

    AgoniArray mSnapshots;
    Class<T> mModelClass;
    protected Class<VH> mViewHolderClass;
    protected int mModelLayout;

    public AgoniAdapter(Class<T> modelClass,
                        @LayoutRes int modelLayout,
                        Class<VH> viewHolderClass,
                        AgoniArray snapshots) {
        ...
        mSnapshots.setOnChangedListener(new ChangeEventListener() {
            ...
            public void onChildChanged(EventType type, int index, int oldIndex) {
                AgoniAdapter.this.onChildChanged(type, index, oldIndex);
            }

            @Override
            public void onDataChanged() {
                AgoniAdapter.this.onDataChanged();
            }

            @Override
            public void onCancelled(DatabaseError error) {
                AgoniAdapter.this.onCancelled(error);
            }
        });
    }
...
//                                   Class<VH> viewHolderClass,
//                                   ArrayList<Query> ref) {
//        this(modelClass, modelLayout, viewHolderClass, new AgoniArray(ref));
//    }
...
//    }
    ...
    public long getItemId(int position) {
        ...
        if (mSnapshots.getItem(position).getValue() instanceof HermesRaw)
            return Integer.valueOf(mSnapshots.getItem(position).getValue(HermesRaw.class).getGdelt());
        else {
            return Integer.valueOf(mSnapshots.getItem(position).getValue(HermesIndex.class).dockey);
        }
    }
